...
Handler.prototype.evaluateRequest = function (request, evaluationResponse, context, WACreds, callback) {
    ...
    if(WACreds) {
        createWAEngine(request, context, WACreds, callback)
            .then(({engine, conversation}) => {
                getIntentity(self, request, engine, (err, intentResult, output) => {
                    getIntentityCallback(err, evaluationResponse, intentResult, output, context, callback);
                })
            })
            .catch((err) => {
...
Handler.prototype.converse = function (request, response, context, WACreds=undefined, callback) {
    let self = this;
    if(WACreds) {
        createWAEngine(request, context, WACreds)
            .then(({engine, conversation}) => {
                ...
                const payload = createConversationPayload(request, WACreds, context);
                conversation.messageAsync(payload)
                    .then((result) => {
                        callConversationCallback(response, result, context, callback);
                    })
                    .catch((err) => {
 ...
 */
let createConversationPayload = function(request, WACreds, context) {
    return {
        workspace_id: WACreds.workspace[request.language].workspace_id,
 ...
 * @param WACreds
 */
let createWAEngine = function(request, context, WACreds) {
 ...
 * @param callback
 */
let callConversationCallback = function(response, result, context, callback) {
 ...
 * @param callback
 */
let getIntentityCallback = function(err, evaluationResponse, intentResult, output, context, callback) {
    if (err) {
