 ...
 */
Handler.prototype.setBuiltInContext = function(context, builtInContext) {
    const validationResult = builtInContextValidation.validateBuiltinContext(builtInContext);
    if(validationResult.valid) {
        context.builtIn = builtInContext;
        console.info('Successfully set built-in context');
    } else {
        console.error('Error setting built-in context: ' + validationResult.errors);
    }
};
 ...
 * @returns {*}
 */
Handler.prototype.getBuiltInContext = function(context) {
