 ...
 */
Handler.prototype.initialize = function (creds) {
    //check if credentials are coming from the handler initialize call from the index.js of the skill
    if(creds){
        this.wcsCredentials = WaEnvUtils.setupWCSCredentialsfromVCAP(creds);
